...
<center><h2>LOGIN FORM</h2></center>
  <div class="imgcontainer">
    <img src="stlog.png" alt="Avatar" class="avatar">
  </div>
...
else 
{
    ...
    <input class="button" type="submit" value="Login" nmae="submit">
    <label>
...
$password = $_POST['pwd'];
$query = mysqli_query($con, "SELECT Username, Password FROM staff WHERE Username = '$username' AND Password = '$password' ");
